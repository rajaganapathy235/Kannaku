...
export const DEFAULT_COMPANY: CompanyProfile = {
  ...
  logoUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="20" fill="%23ECFDF5"/><path d="M25 50 L45 70 L75 30" stroke="%23059669" stroke-width="10" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>',
  signatureName: 'Rajaganapathy K.',
  signatureUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 80"><text x="10" y="55" font-family="Caveat, cursive, sans-serif" font-size="38" font-weight="bold" fill="%23065f46" transform="rotate(-2, 150, 40)">Rajaganapathy K.</text></svg>',
  stampUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 160"><circle cx="80" cy="80" r="74" fill="none" stroke="%23059669" stroke-width="4" stroke-dasharray="8 4"/><circle cx="80" cy="80" r="64" fill="none" stroke="%23059669" stroke-width="2"/><text x="80" y="48" font-size="13" font-family="sans-serif" font-weight="900" fill="%23059669" text-anchor="middle">JUSTGST</text><text x="80" y="86" font-size="11" font-family="sans-serif" font-weight="bold" fill="%23059669" text-anchor="middle">★ RAJAGANAPATHY K. ★</text><text x="80" y="124" font-size="10" font-family="sans-serif" font-weight="900" fill="%23059669" text-anchor="middle">AUTHORIZED SIGNATORY</text></svg>',

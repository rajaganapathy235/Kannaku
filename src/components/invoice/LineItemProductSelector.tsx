...
export const LineItemProductSelector: React.FC<LineItemProductSelectorProps> = ({
  ...
  return (
    <div ref={wrapperRef} className="relative w-full">
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute z-50 left-0 right-0 mt-1 max-h-60 overflow-y-auto bg-white rounded-xl shadow-xl border border-slate-200 py-1 text-xs divide-y divide-slate-100 animate-in fade-in zoom-in-95 duration-100">
          <div className="px-3 py-1.5 bg-slate-50 flex items-center justify-between text-[11px] font-bold text-slate-500 uppercase tracking-wider">
          ...
          {filteredProducts.length === 0 ? (
            <div className="p-3 text-center text-slate-500">
              <p className="font-semibold">No catalog product found matching &quot;{value}&quot;</p>
              <p className="text-[11px] text-slate-400 mt-0.5">
                You can keep typing to use this as a custom line item name.
              </p>
            </div>
          ) : (
                  ...
                  >
                    <div className="flex items-center gap-2 min-w-0 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          {isSelected && (
                            <span className="inline-flex items-center gap-0.5 px-1.5 py-0.2 bg-brand-100 text-brand-800 text-[10px] font-bold rounded">
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <div className="mt-0.5">
                        <span
                          className={`inline-block px-1.5 py-0.2 text-[10px] font-semibold border rounded ${stockColor}`}
                        >

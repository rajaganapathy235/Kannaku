  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/70 backdrop-blur-xs flex items-center justify-center p-2 sm:p-4">
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-4xl max-h-[96vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="no-print p-3 sm:p-4 bg-slate-900 text-white flex items-center justify-between gap-2 border-b border-slate-800">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="truncate">
              ...
              <p className="text-[10px] text-slate-400 font-mono">
                {entries.length} Transaction(s) • Closing Due: ₹{formatNumberIndian(Math.abs(netClosingBalance))} {isDebitBalance ? 'DR' : 'CR'}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            <button
              ...
              className="px-2.5 sm:px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-semibold flex items-center gap-1 transition"
            ...
            <button
              onClick={handlePrint}
              className="px-3 sm:px-4 py-1.5 bg-amber-500 hover:bg-amber-600 text-slate-950 rounded-lg text-xs font-bold flex items-center gap-1.5 shadow-sm transition"
        ...
        <div className="flex-1 overflow-y-auto p-3 sm:p-6 bg-slate-100/60">
          <div
            id="printable-ledger"
            className="printable-document bg-white text-slate-900 mx-auto rounded-xl shadow-xs border border-slate-300 p-4 sm:p-8 max-w-3xl text-xs"
          ...
          >
              ...
              <div className="p-3 bg-slate-50 rounded-lg border border-slate-200 flex flex-col justify-between">
                <div className="grid grid-cols-2 gap-2 text-center">
                  <div className="p-1.5 bg-rose-50 border border-rose-200 rounded">
                    ...
                    <span className="text-xs sm:text-sm font-mono font-black text-[#D93025]">
                ...
                <div className="mt-2 pt-2 border-t border-slate-200 flex items-center justify-between text-xs">
                  ...
                  <span
                    className={`font-mono font-black text-sm ${
                      isDebitBalance ? 'text-[#D93025]' : 'text-emerald-700'
                    }`}
                  >
              ...
              <table className="w-full text-[11px] border-collapse">
                    ...
                    processedEntries.map((entry) => {
                      ...
                      return (
                        <tr key={entry.id || entry.index} className="hover:bg-slate-50/50">
                          ...
                          <td className="py-2 px-2 text-right border-r border-slate-200 font-mono font-bold text-[#D93025] bg-rose-50/30">
                ...
                <tfoot>
                  <tr className="bg-slate-100 border-t-2 border-slate-300 font-bold text-slate-900">
                    ...
                    <td className="py-2 px-2 text-right font-mono text-[#D93025] border-r border-slate-300">
                      ₹{formatNumberIndian(totalDebits)}
                    </td>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-3 border-t-2 border-slate-300 items-end">

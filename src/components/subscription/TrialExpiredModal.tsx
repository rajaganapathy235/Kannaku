...
interface TrialExpiredModalProps {
  ...
  onSimulateState?: (state: 'TRIAL_ACTIVE' | 'TRIAL_EXPIRED' | 'ACTIVE_PAID') => void;
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        {onSimulateState && (
          <div className="bg-slate-100/90 border-t border-slate-200 px-4 py-2.5 flex items-center justify-between text-[11px] text-slate-500">
            <span className="font-semibold text-slate-600">Testing Tools:</span>
            <div className="flex items-center gap-1.5">
              <button
                type="button"
                onClick={() => onSimulateState('TRIAL_ACTIVE')}
                className="px-2 py-0.5 rounded bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 font-medium text-[10px] cursor-pointer"
              ...
              <button
                type="button"
                onClick={() => onSimulateState('ACTIVE_PAID')}
                className="px-2 py-0.5 rounded bg-brand-50 hover:bg-brand-100 border border-brand-200 text-brand-700 font-semibold text-[10px] cursor-pointer"
